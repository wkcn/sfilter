 ...
 */
package android42.sfilter.filters;
...
import android42.sfilter.SGLU;
import android42.sfilter.R;
import android42.sfilter.RenderBuffer;
...
public abstract class CameraFilter {
    ...
    public CameraFilter(Context context) {
        ...
        if (PROGRAM == 0) {
            PROGRAM = SGLU.buildProgram(context, R.raw.vertext, R.raw.original_rtt);
        }
    }
